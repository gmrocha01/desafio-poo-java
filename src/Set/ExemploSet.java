...
public class ExemploSet {
    public static void main(String[] args) {
        ...
        System.out.println("Remova a nota número 0: ");
        notas.remove(0.0);
        ...
        System.out.println("Imprima o LinkedHashSet: " +notas2); //SET NÃO ADICIONA ELEMENTOS REPETIDOS
        System.out.println("Imprima todas as notas na ordem crescente: ");
        Set<Double> notas3 = new TreeSet<>(notas2); //Só é possível fazer isso por que existe Comparable
        System.out.println(notas3);
        System.out.println("Apague todo o conjunto de notas2: ");
        notas2.clear();
